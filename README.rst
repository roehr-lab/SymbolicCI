...
3. **Coupling Evaluation**:
   ...
   \substack{
   \\displaystyle \langle C_{s_1,a_1} \otimes...\otimes C_{s_n,a_n} \vert \mathbf{O_1} \vert C^{^\dagger}_{s_1,a_1}\otimes...\otimes C^{^\dagger}_{s_n,a_n} \rangle  \\
   \\displaystyle + \frac{1}{2} \langle C_{s_1,a_1} \otimes...\otimes C_{s_n,a_n} \vert \mathbf{O_2} \vert C^{^\dagger}_{s_1,a_1}\otimes...\otimes C^{^\dagger}_{s_n,a_n} \rangle 
   }
   $$
